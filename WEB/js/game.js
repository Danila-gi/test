...
import { enemiesPositionsLevel1, gunsPositionsLevel1, emptyCell, desappearingCell,
    enemiesPositionsLevel2, gunsPositionsLevel2, sounds, bonuses } from "./utils.js";
...
export let gameManager = {
        ...
        this.gameInterval = setInterval(() => {
            ...
            if (eventsManager.action['jump']){
                /*if (this.player.isJump){
                    physicManager.jump(this.player);
                    physicManager.jumpArgs = {dx: 10, dy: -15}
                }*/
    ...
    kill: function(i, fire, ArrayObjects){
        ...
        if (bonuses.indexOf(this.points) !== -1){
            this.isBonus = true;
            setTimeout(() => {
                this.isBonus = false;
            }, 5000);
